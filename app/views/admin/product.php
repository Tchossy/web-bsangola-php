...
<div id="modalCreate" class="modal">
  <div class="modal-content">
    ...
    <form id="registerForm" class="modalForm">
      ...
      <input name="images_product[]" class="form-control" type="file" accept="image/" id="inputImagens" multiple>
      ...
      <div>
        ...
        <textarea name="description_product" class="form-control" type="text" placeholder="Descrição do produto"></textarea>
      </div>
      ...
      <div id="characteristics-container">
        ...
        <div class="rowItems">
          <div class="characteristic-input col-md-6 p-sm-0">
            ...
            <input name="name_characteristic[]" type="text" id="characteristic-name-0" class="form-control characteristic-name" required />
          </div>
          <div class="characteristic-input col-md-6 p-sm-0">
            <label for="characteristic-value-0">Valor da Característica 1:</label>
            <input name="value_characteristic[]" type="text" id="characteristic-value-0" class="form-control characteristic-value" required />
          </div>
        </div>
      </div>
...
<div id="modalEdite" class="modal">
  <div class="modal-content">
    ...
    <form id="editForm" class="modalForm">
      ...
      <input name="images_product[]" class="form-control" type="file" accept="image/" id="inputImagensEdit" multiple>
      ...
      <div>
        ...
        <input name="name_product" id="name_product_edite" class="form-control" type="text" placeholder="Nome do produto">
      </div>
      ...
      <div>
        ...
        <textarea name="description_product" id="description_product_edite" class="form-control" type="text" placeholder="Descrição do produto"></textarea>
      </div>
      ...
      <div>
        ...
        <input name="old_price_product" id="old_price_product_edite" class="form-control" type="number" placeholder="Preço Antigo">
      </div>
      <div>
        <label for="new_price_product">
          Preço Novo <span class="text-danger">*</span>
        </label>
        <input name="new_price_product" id="new_price_product_edite" class="form-control" type="number" placeholder="Preço Novo">
      </div>
      ...
      <div id="link_product_container_edit">
        ...
        <input name="link_product" id="link_product_edit" class="form-control" type="text" placeholder="Link do produto">
      </div>
