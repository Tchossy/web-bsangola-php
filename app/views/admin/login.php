              ...
              <div class="ugf-form-block">
                <div class="ugf-form-wrap">
                  <div style="width: 100%; display: flex; align-items: center; justify-content: center;">
                    <img style="width: 22rem; margin: -1.8rem 0 3rem; text-align: center;"
                      src="<?= DASHBOARD_IMG . "/logo-dark.png" ?>" class="img-fluid" alt="">
                  </div>
                  ...
                  <div>
                    ...
                    <p style="margin: -2.8rem 0 3rem; text-align: center;"> Business Solution Angola
                    </p>
                  </div>
